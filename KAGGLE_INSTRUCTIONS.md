# Kaggle Single-Cell Research Script

Copy and paste the entire block below into a single Kaggle notebook cell. It handles all dependencies, datasets, model loading, and research execution automatically.
